...
REM ============================================================
REM  OnlyFix - Windows Developer Init (Transactional)
...
echo.
echo ======================================================
echo    OnlyFix - Developer Environment Init [Windows]
echo ======================================================
...
REM -- Step 10: Wait for MySQL readiness
...
REM -- Step 12: Generate application key
...
REM -- Step 13: Run migrations and seeders
...
REM -- Step 15: Wayfinder route generation
...
echo.
echo ======================================================
echo    [OK] OnlyFix successfully initialized!
echo ======================================================
echo.
echo  Endpoints:
...
echo    Vite HMR:   http://node.onlyfix.local:5173
echo.
echo  Test accounts:
...
echo    1. docker compose down -v --rmi local
echo    2. Remove OnlyFix block from hosts file
echo    3. Delete onlyfix\.env if you want a fresh start
echo    4. Loopback IPs 127.0.1.x need no removal
echo  --------------------------------------------------------
echo.
