    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <SettingsLayout>
            <div class="space-y-6">
                ...
                >
                    <Badge variant="destructive">{{ $t('settings.twoFactor.badgeDisabled') }}</Badge>
                    ...
                    <div>
                        ...
                        >
                            <Button type="submit" :disabled="processing">
                                <ShieldCheck />{{ $t('settings.twoFactor.enable2FA') }}</Button
                            ></Form
                        >
                    </div>
                </div>
                ...
                <div
                    ...
                    class="flex flex-col items-start justify-start space-y-4"
                >
                    <Badge variant="default">{{ $t('settings.twoFactor.badgeEnabled') }}</Badge>
